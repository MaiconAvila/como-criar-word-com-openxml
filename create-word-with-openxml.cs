...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, string arguments)
        {
            ...
            Run run2 = new Run();
            Text text2 = new Text();
            text2.Text = "Quantidade de atendimentos por áreas de negócio";
            ...
            Wp.DocProperties docProperties1 = new Wp.DocProperties() { Id = (UInt32Value)1U, Name = "Gráfico 1" };
        ...
        private void GenerateChartPart1Content(ChartPart chartPart1, string arguments)
        {
            ...
            text9.Text = "Gráfico do Relatório";
            ...
            foreach (var key in arguments)
            {
                ...
                strLit.AppendChild(new C.StringPoint() { Index = new UInt32Value(0u) })
                    .Append(new C.NumericValue($"{ key.legendaÚnicaAbaixoDaBarraDoMeio }"));
